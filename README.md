...
![Pantalla de inicio](docs/screenshot/pantalla_inicio.png)

### Pantalla sorteo
Pantalla para mostrar resultados del sorteo
![Pantalla Principal](docs/screenshot/pantalla_sorteo.png)

### Pantalla carga de participantes
Pantalla para cargar la tabla de participantes para el sorteo
![Pantalla Carga](docs/screenshot/pantalla_carga.png)
